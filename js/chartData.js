...
const scales = {
    ...
    y: {
        ...
        ticks: {
            font: {
                size: (c) => { if (window.innerWidth < 500) return '8ch'; else if (window.innerWidth < 1000) { return '10vw'; } else {return '15vw'};   }  , // You can adjust this value to the desired tick size
                family: 'Inter',
