...
const scales = {
    x: {
        ...
        title: {
            ...
            text: 'Success Rate(%)',
            font: {
                size: (c) => { if (window.innerWidth < 500) return '10ch'; else if (window.innerWidth < 1000) { return '10vw'; } else {return '20vw'};   } ,
                family: 'Inter',
                weight: 'bold'
            }
        },
        ticks: {
            font: {
                size: (c) => { if (window.innerWidth < 500) return '10ch'; else if (window.innerWidth < 1000) { return '10vw'; } else {return '20vw'};   }  // You can adjust this value to the desired tick size
            }
        },
        grid: {
            color: colorGrid,
    ...
    y: {
        ...
        ticks: {
            font: {
                size: (c) => { if (window.innerWidth < 500) return '10ch'; else if (window.innerWidth < 1000) { return '10vw'; } else {return '15vw'};   }  , // You can adjust this value to the desired tick size
                family: 'Inter',
